---
title: "Evans Cohort Secondary Analysis with EpiStats and other useful packages"
...
- **Forward selection**: starts with no variables and adds each new variable incrementally, testing for statistical significance.  
